...
- Ported to Backdrop CMS by [Joe Wickert](https://github.com/joewickert).
- Originally written for Drupal by [Wayne Eaker](https://www.drupal.org/u/zengenuity).
- Inital development sponsored by [DrupalTutor](https://www.drupal.org/drupaltutor-zengenuity)
